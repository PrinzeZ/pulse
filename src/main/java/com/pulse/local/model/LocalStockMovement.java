...
@Entity
@Table(name = "local_stock_movements")
public class LocalStockMovement {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long localMovementId;
    ...
    public Long getLocalMovementId() { return localMovementId; }
    public void setLocalMovementId(Long localMovementId) { this.localMovementId = localMovementId; }
